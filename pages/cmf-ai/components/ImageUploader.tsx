...
export const ImageUploader: React.FC<ImageUploaderProps> = ({
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      {!image ? (
        <div className="relative group w-full h-40 border border-gray-600 hover:border-indigo-400 rounded-lg transition-colors flex flex-col items-center justify-center cursor-pointer overflow-hidden">
          <input
            id={id}
            type="file"
            accept="image/*"
        ...
        <div className="relative w-full h-40 rounded-lg overflow-hidden border border-gray-600 group bg-black/40">
          <img
